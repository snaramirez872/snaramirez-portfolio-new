    ...
    return (
        <div className='AboutMe'>
            <div className='words'>
                ...
                <p className='right-now'>Right now, I'm working on <span className="keywords">SNAR-Dev</span> and <span className="keywords">Effectiveness Dex</span>. More information can be found in the "Projects" tab.</p>
            </div>
